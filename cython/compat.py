...
def list_of_bytes_list_cast(list_, **kwargs):
    """
    Converts any list of string-like items in input list to list of bytes-like values, with
    respect to python version
    Parameters
    ----------
    list_ : list of list
        any list of string-like objects contained in the list will be converted to bytes
    kwargs:
        encoding: str, default: 'utf-8'
            encoding to be used when encoding string
    """
    return [[bytes_cast(elem, **kwargs) for elem in l] for l in list_]
